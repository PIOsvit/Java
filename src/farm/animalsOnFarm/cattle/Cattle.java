package farm.animalsOnFarm.cattle;

import farm.animalsOnFarm.AnimalsOnFarm;

public class Cattle extends AnimalsOnFarm {

	public Cattle(long ID, String sex, float averageAge, float averageWeight) {
