package farm.animalsOnFarm.sheep;

import farm.animalsOnFarm.AnimalsOnFarm;

public class Sheep extends AnimalsOnFarm {

	public Sheep(long ID, String sex, float averageAge, float averageWeight) {
