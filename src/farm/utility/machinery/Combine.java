...
public class Combine extends Utility implements CalcAmortisation {
	...
	public Combine(long id, String name, float gpsLocation, int age,
			String model, int horsePower, float price) {
